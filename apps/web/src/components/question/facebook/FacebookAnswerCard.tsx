      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-1 mt-1 pl-3 text-xs text-gray-600 md:gap-1 md:mt-0.5 md:pl-2 sm:gap-1 sm:mt-0.5 sm:pl-1.5 sm:text-xs">
          ...
          <button
            onClick={handleLike}
            disabled={isLoading}
            className={`!p-0 !m-0 !leading-none flex items-center gap-1 hover:text-red-600 transition-colors md:text-xs sm:text-xs ${
          ...
          <button
            ...
            disabled={isLoading}
            className={`!p-0 !m-0 !leading-none flex items-center gap-1 hover:text-gray-600 transition-colors md:text-xs sm:text-xs ${
