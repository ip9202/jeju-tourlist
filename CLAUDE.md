...
### ⚠️ **검토 대기 중인 문서들**
아래 4개 아키텍처 설계서는 **사용자 검토가 필요**합니다:
- `docs/07-동네물어봐-종합-기술-아키텍처-설계서.md`
- `docs/08-동네물어봐-데이터베이스-아키텍처-설계서.md`
- `docs/09-동네물어봐-API-아키텍처-설계서.md`
- `docs/10-동네물어봐-보안-아키텍처-설계서.md`
